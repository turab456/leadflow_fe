    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between pb-1">
        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">
          Search Results ({totalItems} Businesses Found){" "}
        </p>
      </div>
      ...
      {isLoading ? (
        <div className="bg-white rounded-xl border border-slate-200 p-12">
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <p className="text-sm text-slate-500">Searching businesses...</p>
          </div>
        </div>
      ) : totalItems > 0 ? (
      ...
      >
        <form
          ...
          className="space-y-6 text-slate-800 text-xs font-medium"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, website: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, location: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, size: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, revenue: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, dmName: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewLeadForm({ ...newLeadForm, dmRole: e.target.value })
                  }
                  className="bg-slate-50 border border-slate-200 rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-brand"
                />
              </div>
